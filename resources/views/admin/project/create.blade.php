...
<div class="container">
    ...
    <form action="/admin/project/store" method="post">
        ...
        <div class="form-group">
            ...
            <input type="datetime" class="form-control" id="startingtime" name="startingtime" required>
        </div>
        <div class="form-group">
            <label for="deadline">結束時間</label>
            <input type="datetime" class="form-control" id="deadline" name="deadline" required>
        </div>
